...
document.addEventListener('DOMContentLoaded', function() {
  ...
  whatsappWidget.innerHTML = `
    <a 
      href="https://wa.me/16475729552?text=Hi%20CodexColor!%20I'm%20interested%20in%20your%20services."
      target="_blank"
      rel="noopener noreferrer"
      class="whatsapp-float"
      aria-label="Contact us on WhatsApp"
    >
      <svg class="whatsapp-icon" fill="currentColor" viewBox="0 0 24 24" width="32" height="32">
